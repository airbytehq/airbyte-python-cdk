...
class _CsvReader:
    def read_data(
        ...
        try:
            with stream_reader.open_file(
                ...
                try:
                    headers, trailing_empty_header_count = self._read_and_validate_headers(
    ...
    def _read_and_validate_headers(
        ...
        headers, trailing_empty_header_count = self._validate_trailing_headers(raw_headers)

        fp.seek(0)
        return headers, trailing_empty_header_count

    def _validate_trailing_headers(self, raw_headers: List[str]) -> Tuple[List[str], int]:
