...
class PerPartitionRequestOptionsProvider(RequestOptionsProvider):
    ...
    def get_request_params(self, *, stream_state: Optional[StreamState] = None,
    ...
    def get_request_headers(self, *, stream_state: Optional[StreamState] = None,
                            stream_slice: Optional[StreamSlice] = None,
                            next_page_token: Optional[Mapping[str, Any]] = None) -> Mapping[str, Any]:
    ...
    def get_request_body_data(self, *, stream_state: Optional[StreamState] = None,
                              stream_slice: Optional[StreamSlice] = None,
    ...
    def get_request_body_json(self, *, stream_state: Optional[StreamState] = None,
                              stream_slice: Optional[StreamSlice] = None,
                              next_page_token: Optional[Mapping[str, Any]] = None) -> Mapping[str, Any]:
