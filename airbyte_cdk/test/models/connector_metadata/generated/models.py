...
from pydantic.v1 import AnyUrl, BaseModel, Extra
...
class RegistryOverrides(BaseModel):
    ...
    oss: Optional[RegistryOverrides_1] = None
    cloud: Optional[RegistryOverrides_1] = None
...
class Data(BaseModel):
    ...
    registryOverrides: Optional[RegistryOverrides] = None
