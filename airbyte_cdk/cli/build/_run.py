...
def parse_args(args: List[str]) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Build connector Docker images using the host Docker daemon")
    parser.add_argument(
        "connector_dir", 
        type=str, 
    ...
    parser.add_argument(
        ...
        type=str, 
        default="dev", 
        help="Tag to apply to the built image (default: dev)"
    )
    parser.add_argument(
        "--platform",
        type=str,
    ...
    parser.add_argument(
        "--no-verify",
        action="store_true",
        help="Skip verification of the built image"
    )
    parser.add_argument(
        "--verbose", 
        "-v", 
...
def build_from_dockerfile(
    ...
    build_cmd = [
        ...
        "--platform", platform,
        "-t", full_image_name,
        "--label", f"io.airbyte.version={metadata.dockerImageTag}",
        "--label", f"io.airbyte.name={metadata.dockerRepository}",
        str(connector_dir)
    ]
