...
from airbyte_cdk.connector_builder.test_reader.helpers import _create_response_from_log_message
...
def test_create_response_from_log_message(
    ...
    assert _create_response_from_log_message(response_message) == expected_response
